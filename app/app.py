...
def ensure_lat_lon(gdf: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
    # Make sure geometry is in WGS84 for centroid
    try:
        if gdf.crs is None or gdf.crs.to_epsg() != 4326:
            gdf = gdf.to_crs(4326)
    except Exception:
        pass
    # Safe centroid (without mutating original geometries)
